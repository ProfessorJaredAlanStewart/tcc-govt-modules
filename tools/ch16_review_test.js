...
const F="Chapter 16 - Domestic Policy (Expanded Edition).html";
...
setTimeout(()=>{
  ...
  const entries=[...d.querySelectorAll('[onclick]')].filter(e=>/navigateTo\('review'\)/.test(e.getAttribute('onclick')||''));
