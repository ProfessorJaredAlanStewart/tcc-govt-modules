...
const F="Chapter 10 - Interest Groups and Lobbying (Expanded Edition).html";
...
setTimeout(()=>{
  ...
  const entries=[...d.querySelectorAll('[onclick]')].filter(e=>/showChapterReview\(\)/.test(e.getAttribute('onclick')||''));
